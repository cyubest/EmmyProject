...
{
  title:'Turwanye sida bantu beza',
  description:'Mureke duhaguruke nshuti ibintu byarakaze pe',
  date:new Date()
},
{
  title:'Turwanye Igituntu bantu beza',
  description:'Mureke duhaguruke nshuti ibintu byarakaze pe',
  date:new Date()
},
{
  title:'Turwanye Malaria bantu beza',
  description:'Mureke duhaguruke nshuti ibintu byarakaze pe',
  date:new Date()
}
]
  ...
  const [questionList,setQuestionList]= useState([])
    const htmlContent = `
        <html>
          ...
          <body>
            <header>
              <h1>STATISTICAL REPORT For ALL SURVEYS</h1>
              <address>
                <p>Reporter</p>
                <p>NSHIMIYIMANA Emmanuel</p>
                <p>0781234565</p>
              </address>
            </header>
            <article>
                  ...
                  ${questionList.map(item=>{
                    return(
                      `<tr>
                          ...
                          <td><span>${moment(item.created_on).utcOffset(0, true).format('dddd, MMMM Do YYYY, h:mm:ss a')}</span></td>
                        </tr>`
                    )
                  })}
      ...
      const createPDF = async () => {
        let options = {
          ...
          html: htmlContent,
          //File Name
          fileName: 'Survey-Question-Report',
          //File directory
          directory: 'Download',
